...
<li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="views/utilities-color.php">Colors</a>
            <a class="collapse-item" href="views/utilities-border.php">Borders</a>
            <a class="collapse-item" href="views/utilities-animation.php">Animations</a>
            <a class="collapse-item" href="views/utilities-other.php">Other</a>
        </div>
    </div>
</li>
